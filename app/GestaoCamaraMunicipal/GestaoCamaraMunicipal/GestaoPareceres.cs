...
namespace GestaoCamaraMunicipal
{
    public partial class GestaoPareceres : Form
    {
        ...
        {
            MessageBox.Show(" Formulário de Gestão de Pareceres tem" +
                " como principal objetivo a atribuição de pareceres" +
                " a um dado projeto. Para esse efeito existem validações" +
                " de dados que devem ser respeitadas. Deste modo, todos " +
                "os dados são validados e verificados, devendo estes estarem" +
                " corretos. Ao adicionar um parecer, quando o mesmo for criado, " +
                "serão guardados os seus dados na base de dados e mostrados na" +
                " respetiva lista disponível no formulário.", "Ajuda DPM");
