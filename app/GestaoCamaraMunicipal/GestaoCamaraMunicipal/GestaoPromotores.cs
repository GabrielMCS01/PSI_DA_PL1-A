...
namespace GestaoCamaraMunicipal
{
    public partial class GestaoPromotores : Form
    {
        ...
        {
            MessageBox.Show("O Formulário de Gestão de Promotores tem como " +
                "principal objetivo a inserção de Promotores. Para esse " +
                "efeito existem validações de dados que devem ser respeitadas. " +
                "Deste modo, todos os dados são validados e verificados, devendo " +
                "estes estarem corretos. Ao adicionar um promotor, quando o mesmo " +
                "for criado, serão guardados os seus dados na base de dados e mostrados" +
                " na respetiva lista disponível no formulário. ", "Ajuda DPM");
        }
    }
}
